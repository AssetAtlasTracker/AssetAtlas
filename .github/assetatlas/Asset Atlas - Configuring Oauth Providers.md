...
2) Github OAuth Registration (read fully before starting)  
   ...
   3) You will also be prompted for an “Authorization callback URL”. This will be the home page url \+ “/api/oauth/callback2”, so “http://localhost:3000/api/oauth/callback2” if following the previous example.  
...
3. ### Adding data to “secrets.env”
   ...
   GOOGLE\_REDIRECT\_URI=\<homepage\>/api/oauth/callback1  
   GITHUB\_CLIENT\_ID=\<insert github client id\>  
   GITHUB\_CLIENT\_SECRET=\<insert github client secret\>  
   GITHUB\_REDIRECT\_URI=\<homepage\>/api/oauth/callback2
