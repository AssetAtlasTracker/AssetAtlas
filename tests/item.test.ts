...
import { POST as createItemHandler } from '../src/routes/api/items/+server.js';
import { GET as getItemByIdHandler, PATCH as updateItemHandler, DELETE as deleteItemHandler } from '../src/routes/api/items/[id]/+server.js';
import { GET as searchItemsHandler } from '../src/routes/api/items/search/+server.js';
import { POST as moveItemHandler } from '../src/routes/api/items/move/+server.js';
import { GET as getAllContainedHandler } from '../src/routes/api/items/allContained/[parentID]/+server.js';
import { GET as getParentChainHandler } from '../src/routes/api/items/parentChain/[id]/+server.js';
import { GET as getTreeHandler } from '../src/routes/api/items/tree/[id]/+server.js';
import { POST as createCustomFieldHandler } from '../src/routes/api/customFields/+server.js';
import { DELETE as deleteTemplateHandler } from '../src/routes/api/templates/[id]/+server.js';
import { PUT as editTemplateHandler } from '../src/routes/api/templates/editTemplate/[id]/+server.js';
